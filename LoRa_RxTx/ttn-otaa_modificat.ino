...
// 0x70.
static const u1_t PROGMEM APPEUI[8]={ 0xC9, 0xCF, 0x02, 0xD0, 0x7E, 0xD5, 0xB3, 0x70 };
...
static const u1_t PROGMEM APPKEY[16] = { 0x09, 0x80, 0x5D, 0x4B, 0x91, 0x7F, 0x2B, 0xBD, 0x4C, 0x64, 0x92, 0xD4, 0xF2, 0x69, 0xFD, 0xA0 };
...
// Pin mapping folosit de mariusica
const lmic_pinmap lmic_pins = {
    .nss = 10,
    .rxtx = LMIC_UNUSED_PIN,
    .rst = 9,
...
/*******************************
 * Modificari ca sa mearga doar pe o frecventa si un singur SF
 */
...
void onEvent (ev_t ev) {
    ...
    switch(ev) {
        ...
        case EV_JOINED:
            ...
            forceTxSingleChannelDr(); // -> modificare single channel
...
void setup() {
    ...
    Serial.println(F("ajuns la primul send job"));
    do_send(&sendjob);
    Serial.println(F("trecut de primul send job"));
}
